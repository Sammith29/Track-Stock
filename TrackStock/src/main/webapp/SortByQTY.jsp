          ...
          <div id="body">
            <div class="card-header">
              <div>
                ...
                <a id="filters" href='#'>QTY</a>
              </div>
              <div>
                <form action="" method="get">
                    <div class="input-box">
                     <!--<label for="QR" style="font-size: 22px;">QR</label>-->
                ...
                <table>
                  ...
                  <% String QTY = request.getParameter("QTY");
                    ...
                    try {
                      ...
                      String sql = "SELECT * FROM stockdetails WHERE Quantity = ?";
                      ps = conn.prepareStatement(sql);
                      ps.setString(1, QTY); // Bind parameter here
                      rs = ps.executeQuery();
