                ...
                <form action="" method="get">
                    <div class="input-box">
                     <!--<label for="QR" style="font-size: 22px;">QR</label>-->
                        <input type="text" class="input-field" name="QRCode" placeholder="QR">
                ...
                <table>
                  ...
                  <% String QR = request.getParameter("QRCode");
                    ...
                    try {
                      ...
                      String sql = "SELECT * FROM stockdetails WHERE QRCode = ?";
                      ps = conn.prepareStatement(sql);
                      ps.setString(1, QR); // Bind parameter here
                      rs = ps.executeQuery();
