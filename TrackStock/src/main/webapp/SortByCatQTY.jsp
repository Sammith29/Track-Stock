          ...
          <div id="body">
            <div class="card-header">
              <div>
                ...
                <a id="filters"  href='<%= response.encodeRedirectURL("SortByCategory.jsp") %>'>Category</a>
                <a id="filters" href='<%= response.encodeRedirectURL("SortByQR.jsp") %>'>QR</a>
                <a id="filters" href='#'>Catagory with QTY</a>
              ...
              <div>
                <form action="" method="get">
                    ...
                    <select name="selectedCategory" id="productCategory" required>
                       ...
                       <!--<label for="QTY" style="font-size: 22px;">QR</label>-->
                        <input type="text" class="input-field" name="QTY" placeholder="QTY">
                ...
                <table>
                  ...
                  <% String selectedCategory = request.getParameter("selectedCategory");
                    ...
                    try {
                      ...
                      String sql = "SELECT * FROM stockdetails WHERE  Quantity = ? AND Category = ? ";
                      ps = conn.prepareStatement(sql);
                      ps.setString(1, QTY);
                      ps.setString(2, selectedCategory); // Binding parameter 
                      rs = ps.executeQuery();
